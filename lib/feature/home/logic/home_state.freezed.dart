...
mixin _$HomeState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(HomeResponseModel data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(HomeResponseModel data)? success,
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({HomeResponseModel data});
}
...
abstract class Success<T> implements HomeState<T> {
  const factory Success(final HomeResponseModel data) = _$SuccessImpl<T>;

  HomeResponseModel get data;
  @JsonKey(ignore: true)
  _$$SuccessImplCopyWith<T, _$SuccessImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
